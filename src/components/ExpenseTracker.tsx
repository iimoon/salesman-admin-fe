...
export default function ExpenseTracker() {
    return (
        <div className="bg-[#F9FAFC] h-[95vh] p-10 w-sm rounded-tr-lg rounded-br-lg">
            <h1 className="text-center font-medium text-xl text-gray-700">Where did your money go?</h1>
            <div className="items-center">
                ...
                <div className="bg-[#EDF0F6] mt-30 p-6 rounded-xl h-70 shadow-md w-72 text-center relative">
